...
├── .env # Gemini API key + DB path
│
├── index.html # Homepage (quiz type selection)
├── quiz.html # Displays generated quiz
├── script.js # Frontend logic (UI + API)
│
├── static/ (optional) # Assets, images, CSS if needed
│
